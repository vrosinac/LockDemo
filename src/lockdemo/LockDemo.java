...
public class LockDemo {
    ...
    public static void main(String[] args) {
	 ...
	 Calendar c = Calendar.getInstance();
         ...
         sout = sout+"<br>" + "(last update: " +dtf.format(now) + " " + stz + ")<br> please reach jamesalexander.johnfuller@finastra.com, piotr.weglarz@finastra.com or vincent.rosinach@finastra.com if the page stops refreshing<br><br>"; //2016/11/16 12:08:43
